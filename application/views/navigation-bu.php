...
<li><a <?php if($this->uri->segment(1) == 'about-pinpoint-africa-media') echo "class = 'current'" ?> id = 'about' href = 'about-pinpoint-africa-media' title = 'About PinPoint Africa Media'>&nbsp;</a></li>
<li><a <?php if($this->uri->segment(1) == 'contact-pinpoint-africa') echo "class = 'current'" ?> id = 'contact' href = 'contact-pinpoint-africa' title = 'Contact Us'>&nbsp;</a></li>
