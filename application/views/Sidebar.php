	...
	<aside>
		...
		<?php foreach($uploader_songs->result() as $uploader_song): ?>
			<p style = 'margin-bottom: 5px; font-weight: normal;'><a style = 'font-weight: normal;' href="song/<?php echo $uploader_song->url; ?>"><?php echo $uploader_song->jina_la_wimbo ?></a> - <?php echo $uploader_song->mtunzi ?></p>
		<?php endforeach; ?>
		...
		<?php foreach($recent_songs->result() as $recent_song): ?>
			<p style = 'margin-bottom: 5px;'><a style = 'font-weight: normal;' href="song/<?php echo $recent_song->url; ?>"><?php echo $recent_song->jina_la_wimbo ?></a> - <?php echo $recent_song->mtunzi ?></p>
		<?php endforeach; ?>
