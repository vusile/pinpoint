	...
	<body>
		...
		<div class="container container_12">
			...
			<?php endif; ?>
				...
				<p class = 'headerfont'><?php if(isset($intro)) echo strip_tags($intro,'<br><br/>'); ?></p>
				<p style="margin-top:0px;" ><?php if(isset($intro_p)) echo strip_tags($intro_p); ?></p>
